...
def get_default_arguments():
    ...
    parser.add_argument("--dataset_dir", type=str, default="KGs/Family",
    ...
    parser.add_argument('--alpha', type=int, default=1,
                        help='Weight of KGE Model for combined Training')
    ...
    parser.add_argument('--literal_training', action="store_true", default=True,
                        help='Training of  Literal Embedding Model')
    parser.add_argument('--multi_regression', action="store_true", default=False,
