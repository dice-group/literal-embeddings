...
def get_default_arguments(args_list=None):
    ...
    parser.add_argument(
        "--weight_decay", type=float, default=0.0, help="L2 penalty e.g.(0.00001)"
    )
    ...
    parser.add_argument(
        "--label_smoothing_rate", type=float, default=0.0, help="None for not using it."
    )
    parser.add_argument(
        "--kernel_size",
        type=int,
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Use literals within KGE models",
    )
    parser.add_argument(
